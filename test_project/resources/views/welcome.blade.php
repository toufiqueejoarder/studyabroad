...
<div class="jumbotron text-center " id="AA" style="background-image: url('img/7.png') ; position:relative;margin-top: -30px;">
    ...
    <div id="Login" style=" display:none;padding: 0px 16px 32px;
        margin-left: 885px;background-color: #FFFFFF;position: absolute;    margin-top: -34px;text-align: left; z-index: 2;">

        <p style="color: black;margin: 0px 0px -21px ;text-align: center;">Free access to all our programmes and services</p><br>
        <div id="G" style="background-color: #4285F4;padding:3px 15px 3px;color: #FFFFFF;margin: auto;">
            <a href="{{route('login.google')}}"><i class="fa fa-google-plus-square"  style="font-size:45px;color: #FFFFFF;margin: 1px 14px 1px; "><p style="font-size: 23px;
            float: right;
            margin-top: 9px;
          margin-left: 19px;">Login With Google</p></i></a>
        </div>

        <div id="F" style="background-color: #4267B2;padding:0px 15px 0px;color: #FFFFFF;margin: auto;">
            <a href="{{route('login.facebook')}}"><i class="fa fa-facebook-official" style="font-size:45px;color: #FFFFFF;margin: 1px 14px 1px; "><p style="font-size: 23px;
            float: right;
            margin-top: 9px;
          margin-left: 19px;">Login With Facebook</p></i></a>
        </div>
        <div style="background-color: #FFFFFF;padding:3px 15px 3px;color: #FFFFFF;margin: auto;    border: dotted;
          border-color: black;">
            <a href="/login"><i class="fa fa-envelope" style="font-size:45px;color: black;margin: 1px 14px 1px; "><p style="font-size: 23px;
            float: right;
            margin-top: 9px;
          margin-left: 19px;">Login With Email</p></i></a>
    ...
    <div class="container-fluid"  >
        <div class="row">
            <div class="col-sm-12" style="margin-top: 200px;margin-bottom: 50px; z-index: 1;">
...
<div class="container-fluid" style="padding: 14px 320px 31px;background-color:#EDF3F6;">
    <div class="row">
        <div class="col-sm-12">
            <a href="https://www.latrobe.edu.au/"><img src="img/25.png" style="width: 100%;height: 100%;"></a>
        </div>
