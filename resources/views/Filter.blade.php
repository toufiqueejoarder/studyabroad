                                                            ...
                                                            <div class="Screen">
                                                                <div class="FormWrapper">
                                                                    <form method="get" action="{{ url('/search-master-degree/'.$discipline.'/locations') }}">
                                                                        ...
                                                                        <p><input type="checkbox" name="id" value="Canada" onchange="this.form.submit()" <?php if($query=="Canada") echo "checked";?> ><em> Canada</em></p>
                                                                        <p><input type="checkbox" name="id2" value="United States" onchange="this.form.submit()" <?php if($query2=="United States") echo "checked";?>><em> United states</em></p>
                                                                        <p><input type="checkbox" name="id3" value="Finland" onchange="this.form.submit()" <?php if($query3=="Finland") echo "checked";?>><em> Finland</em></p>
                                                                        <p><input type="checkbox" name="id4" value="Australia" onchange="this.form.submit()" <?php if($query4=="Australia") echo "checked";?>><em> Australia</em></p>
                                                                        <p><input type="checkbox" name="id5" value="Germany" onchange="this.form.submit()" <?php if($query5=="Germany") echo "checked";?>><em> Germany</em></p>
                                                                        @if($query6)
                                                                            <p><input type="checkbox" name="" value={{$query6}} onchange="this.form.submit()" <?php echo "checked";?>><em> {{$query6}}</em></p>
                                                                        @endif
                                        ...
                                        <div class="panel-body">
                                            <section id="trFilter" data-cy="trFilter" class="RefineModule"><h3 class="RefineSectionHeading">
                                                    ...
                                                    <form method="get" action="{{ url('/search-master-degree/'.$discipline.'/locations') }}">
                                                        ...
                                                        <p><input type="checkbox" name="fee1" value="1000,5000" onchange="this.form.submit()" ><em> 1000-5000</em></p>
                                                        <p><input type="checkbox" name="fee1" value="5000,10000" onchange="this.form.submit()" ><em> 5000-10,000</em></p>
                                                        <p><input type="checkbox" name="fee1" value="10000,20000" onchange="this.form.submit()" ><em> 10000-20,000</em></p>
                                    ...
                                    <div class="">
                                        <div class="tab-content" id="nav-tabContent">
                                            <div class="tab-pane fade show active" id="pop1" role="tabpanel" aria-labelledby="pop1-tab">
                                                ...
                                                @endforeach
                                                <div class="d-flex justify-content-end py-4">{{$program->links()}}</div>
                                            </div>
                                            <div class="tab-pane fade" id="pop2" role="tabpanel" aria-labelledby="pop2-tab">
                                                ...
                                                @endforeach
                                                <div class="">{{$programBCost->links()}}</div>
                                            </div>
