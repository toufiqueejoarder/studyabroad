                        ...
                        <aside id="SPScholarships">
                            <div class="ContentCard">
                                <div class="SPScholarshipsContent">
                                    <h2>Scholarship options for {{$uniData->organization}}!</h2>
