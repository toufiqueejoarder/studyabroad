                        ...
                        <div class="card-body">
                            <form action="{{route('add.programs')}}" method="post" enctype="multipart/form-data">
                                        ...
                                        <select class="btn btn-outline-secondary dropdown-toggle" data-toggle="dropdown" name="faculty">
                                            <div class="dropdown-menu">
                                                ...
                                                @foreach($faculty as $row)
                                                    <option class="dropdown-item" value="{{$row->departments}}">{{$row->departments}}</option>
                                                @endforeach
                                            </div>
                                        </select>
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="btn btn-outline-secondary dropdown-toggle" data-toggle="dropdown" name="status">
                                        <div class="dropdown-menu">
                                            ...
                                            <option class="dropdown-item" value="Part Time, Full Time">Part Time, Full Time</option>
                                        </div>
                                    </select>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" aria-describedby="fees" placeholder="1,000" name="fees">
                                </div>
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group d-flex">
                                            <label for="exampleInputEmail1">Application Date Starts Season 1: </label>
                                            <input type="text" class="form-control" aria-describedby="Apply Start" placeholder=" MM-DD-YYYY (02-25-2021)" name="apply_startS1">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group d-flex">
                                            <label for="exampleInputEmail1">Application Date ends Season 1: </label>
                                            <input type="text" class="form-control" aria-describedby="Apply Start" placeholder="MM-DD-YYYY (02-25-2021)" name="apply_endS1">
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group d-flex">
                                            ...
                                            <input type="text" class="form-control" aria-describedby="Apply Start" placeholder=" MM-DD-YYYY (02-25-2021)" name="apply_startS2">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group d-flex">
                                            <label for="exampleInputEmail1">Application Date ends Season 2: </label>
                                            <input type="text" class="form-control" aria-describedby="Apply Start" placeholder="MM-DD-YYYY (02-25-2021)" name="apply_endS2">
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" aria-describedby="program structure" col="50" row="5" placeholder="Write Your Program Structure Here. only the areas this course complete should be writen here. Separate each area by full stop (.)" name="program_structure" style="min-width: 100%;"></textarea>
                                </div>
                                <div class="form-group">
                                    <label for="exampleInputEmail1">Total Course Credits</label>
                                    <input type="text" class="form-control" aria-describedby="Academic Requirements" placeholder="Total Course Credit" name="credit">
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" aria-describedby="workPermit" placeholder="Course Official Website Link" name="course_link">
                                </div>
